		...
		<div class="span12">
			<div class="grif large">
				<p class="center title colored">
					<img src="http://sro61.ru/images/print-logo.png" alt="" width="220" style="margin-bottom: 6px;"/><br/>
					...
					<span>e-mail: sro61@mail.ru, www: sro61.ru</span><br/>
	...
	<div class="row">
		<div class="span12">
			...
			<p class="intend main">
				...
				<nobr>№ {number}</nobr>, составленный на организацию - {customer} (ИНН {inn}), 
