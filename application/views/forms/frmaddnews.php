<?=form_open_multipart($this->uri->uri_string(),array('class'=>'form-horizontal')); ?>
	...
	<fieldset>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span6 input-valid" name="title" value="<?=set_value('title');?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span6 input-valid" name="small_title" value="<?=set_value('small_title');?>">
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<textarea rows="10" class="span6 input-valid redactor" name="text"><?=set_value('text');?></textarea>
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<textarea rows="5" class="span6 input-valid redactor" name="small_text"><?=set_value('small_text');?></textarea>
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
		<div class="control-group">
